defmodule DndstoreWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(DndstoreWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(DndstoreWeb.Gettext, "errors", msg, opts)
    end
  end
